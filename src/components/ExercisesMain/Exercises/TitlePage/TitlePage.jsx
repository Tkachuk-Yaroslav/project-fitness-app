...
const TitlePage = () => {
	...
	const capitalizedEquipmentId = equipmentId
		...
		: '';
	const capitalizedMuscles = muscles ? muscles.slice(0, 1).toUpperCase() + muscles.slice(1) : '';

	return (
		<>
			<TitleDiv>
				<TitleH1Styled>
					{capitalizedBodyParts || capitalizedMuscles || capitalizedEquipmentId || 'Exercises'}
				</TitleH1Styled>
			</TitleDiv>
		</>
	);
